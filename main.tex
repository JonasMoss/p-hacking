...
% The foEquation \eqref{eq:H-selection model} we see that  
% \begin{prop}
...
% Let $f(x,\theta_i\mid\eta_i)=f(x\mid\theta_i,\eta)p(\theta_i)$
% be the joint density of a random effects meta-analysis, where $x_i$ is the effect size, $\theta_i$ is the study-specific parameter, and $\eta$ is a nuisance parameter such as the sample size of the study. 
